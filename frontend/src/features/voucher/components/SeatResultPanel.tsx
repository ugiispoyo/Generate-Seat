...
function SeatResultPanel({ seats, onRetry }: SeatResultPanelProps) {
  return (
    <aside
    ...
    >
      ...
      <h2 className="mt-4 font-display text-2xl font-bold text-skybrand-900">
        Assigned Seats
      </h2>
      ...
      <div className="mt-8 rounded-2xl border border-skybrand-100 bg-skybrand-50/70 p-4">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-skybrand-500">
          Rule Snapshot
        </p>
